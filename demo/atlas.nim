...
var atlas_texture = [
  0x00.uint8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
var atlas = {
  ...
  ATLAS_WHITE : Rect(x:125,y:68,w:3,h:3),
  ATLAS_FONT+32 : Rect(x:84,y:68,w:2,h:17),
  ATLAS_FONT+33 : Rect(x:39,y:68,w:3,h:17),
  ATLAS_FONT+34 : Rect(x:114,y:51,w:5,h:17),
  ATLAS_FONT+35 : Rect(x:34,y:17,w:7,h:17),
  ATLAS_FONT+36 : Rect(x:28,y:34,w:6,h:17),
  ATLAS_FONT+37 : Rect(x:58,y:0,w:9,h:17),
  ATLAS_FONT+38 : Rect(x:103,y:0,w:8,h:17),
  ATLAS_FONT+39 : Rect(x:86,y:68,w:2,h:17),
  ATLAS_FONT+40 : Rect(x:42,y:68,w:3,h:17),
  ATLAS_FONT+41 : Rect(x:45,y:68,w:3,h:17),
  ATLAS_FONT+42 : Rect(x:34,y:34,w:6,h:17),
  ATLAS_FONT+43 : Rect(x:40,y:34,w:6,h:17),
  ATLAS_FONT+44 : Rect(x:48,y:68,w:3,h:17),
  ATLAS_FONT+45 : Rect(x:51,y:68,w:3,h:17),
  ATLAS_FONT+46 : Rect(x:54,y:68,w:3,h:17),
  ATLAS_FONT+47 : Rect(x:124,y:34,w:4,h:17),
  ATLAS_FONT+48 : Rect(x:46,y:34,w:6,h:17),
  ATLAS_FONT+49 : Rect(x:52,y:34,w:6,h:17),
  ATLAS_FONT+50 : Rect(x:58,y:34,w:6,h:17),
  ATLAS_FONT+51 : Rect(x:64,y:34,w:6,h:17),
  ATLAS_FONT+52 : Rect(x:70,y:34,w:6,h:17),
  ATLAS_FONT+53 : Rect(x:76,y:34,w:6,h:17),
  ATLAS_FONT+54 : Rect(x:82,y:34,w:6,h:17),
  ATLAS_FONT+55 : Rect(x:88,y:34,w:6,h:17),
  ATLAS_FONT+56 : Rect(x:94,y:34,w:6,h:17),
  ATLAS_FONT+57 : Rect(x:100,y:34,w:6,h:17),
  ATLAS_FONT+58 : Rect(x:57,y:68,w:3,h:17),
  ATLAS_FONT+59 : Rect(x:60,y:68,w:3,h:17),
  ATLAS_FONT+60 : Rect(x:106,y:34,w:6,h:17),
  ATLAS_FONT+61 : Rect(x:112,y:34,w:6,h:17),
  ATLAS_FONT+62 : Rect(x:118,y:34,w:6,h:17),
  ATLAS_FONT+63 : Rect(x:119,y:51,w:5,h:17),
  ATLAS_FONT+64 : Rect(x:18,y:0,w:10,h:17),
  ATLAS_FONT+65 : Rect(x:41,y:17,w:7,h:17),
  ATLAS_FONT+66 : Rect(x:48,y:17,w:7,h:17),
  ATLAS_FONT+67 : Rect(x:55,y:17,w:7,h:17),
  ATLAS_FONT+68 : Rect(x:111,y:0,w:8,h:17),
  ATLAS_FONT+69 : Rect(x:0,y:35,w:6,h:17),
  ATLAS_FONT+70 : Rect(x:6,y:35,w:6,h:17),
  ATLAS_FONT+71 : Rect(x:119,y:0,w:8,h:17),
  ATLAS_FONT+72 : Rect(x:18,y:17,w:8,h:17),
  ATLAS_FONT+73 : Rect(x:63,y:68,w:3,h:17),
  ATLAS_FONT+74 : Rect(x:66,y:68,w:3,h:17),
  ATLAS_FONT+75 : Rect(x:62,y:17,w:7,h:17),
  ATLAS_FONT+76 : Rect(x:12,y:51,w:6,h:17),
  ATLAS_FONT+77 : Rect(x:28,y:0,w:10,h:17),
  ATLAS_FONT+78 : Rect(x:67,y:0,w:9,h:17),
  ATLAS_FONT+79 : Rect(x:76,y:0,w:9,h:17),
  ATLAS_FONT+80 : Rect(x:69,y:17,w:7,h:17),
  ATLAS_FONT+81 : Rect(x:85,y:0,w:9,h:17),
  ATLAS_FONT+82 : Rect(x:76,y:17,w:7,h:17),
  ATLAS_FONT+83 : Rect(x:18,y:51,w:6,h:17),
  ATLAS_FONT+84 : Rect(x:24,y:51,w:6,h:17),
  ATLAS_FONT+85 : Rect(x:26,y:17,w:8,h:17),
  ATLAS_FONT+86 : Rect(x:83,y:17,w:7,h:17),
  ATLAS_FONT+87 : Rect(x:38,y:0,w:10,h:17),
  ATLAS_FONT+88 : Rect(x:90,y:17,w:7,h:17),
  ATLAS_FONT+89 : Rect(x:30,y:51,w:6,h:17),
  ATLAS_FONT+90 : Rect(x:36,y:51,w:6,h:17),
  ATLAS_FONT+91 : Rect(x:69,y:68,w:3,h:17),
  ATLAS_FONT+92 : Rect(x:124,y:51,w:4,h:17),
  ATLAS_FONT+93 : Rect(x:72,y:68,w:3,h:17),
  ATLAS_FONT+94 : Rect(x:42,y:51,w:6,h:17),
  ATLAS_FONT+95 : Rect(x:15,y:68,w:4,h:17),
  ATLAS_FONT+96 : Rect(x:48,y:51,w:6,h:17),
  ATLAS_FONT+97 : Rect(x:54,y:51,w:6,h:17),
  ATLAS_FONT+98 : Rect(x:97,y:17,w:7,h:17),
  ATLAS_FONT+99 : Rect(x:0,y:52,w:5,h:17),
  ATLAS_FONT+100 : Rect(x:104,y:17,w:7,h:17),
  ATLAS_FONT+101 : Rect(x:60,y:51,w:6,h:17),
  ATLAS_FONT+102 : Rect(x:19,y:68,w:4,h:17),
  ATLAS_FONT+103 : Rect(x:66,y:51,w:6,h:17),
  ATLAS_FONT+104 : Rect(x:111,y:17,w:7,h:17),
  ATLAS_FONT+105 : Rect(x:75,y:68,w:3,h:17),
  ATLAS_FONT+106 : Rect(x:78,y:68,w:3,h:17),
  ATLAS_FONT+107 : Rect(x:72,y:51,w:6,h:17),
  ATLAS_FONT+108 : Rect(x:81,y:68,w:3,h:17),
  ATLAS_FONT+109 : Rect(x:48,y:0,w:10,h:17),
  ATLAS_FONT+110 : Rect(x:118,y:17,w:7,h:17),
  ATLAS_FONT+111 : Rect(x:0,y:18,w:7,h:17),
  ATLAS_FONT+112 : Rect(x:7,y:18,w:7,h:17),
  ATLAS_FONT+113 : Rect(x:14,y:34,w:7,h:17),
  ATLAS_FONT+114 : Rect(x:23,y:68,w:4,h:17),
  ATLAS_FONT+115 : Rect(x:5,y:52,w:5,h:17),
  ATLAS_FONT+116 : Rect(x:27,y:68,w:4,h:17),
  ATLAS_FONT+117 : Rect(x:21,y:34,w:7,h:17),
  ATLAS_FONT+118 : Rect(x:78,y:51,w:6,h:17),
  ATLAS_FONT+119 : Rect(x:94,y:0,w:9,h:17),
  ATLAS_FONT+120 : Rect(x:84,y:51,w:6,h:17),
  ATLAS_FONT+121 : Rect(x:90,y:51,w:6,h:17),
  ATLAS_FONT+122 : Rect(x:10,y:68,w:5,h:17),
  ATLAS_FONT+123 : Rect(x:31,y:68,w:4,h:17),
  ATLAS_FONT+124 : Rect(x:96,y:51,w:6,h:17),
  ATLAS_FONT+125 : Rect(x:35,y:68,w:4,h:17),
  ATLAS_FONT+126 : Rect(x:102,y:51,w:6,h:17),
  ATLAS_FONT+127 : Rect(x:108,y:51,w:6,h:17)
}.toTable
